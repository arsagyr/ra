...
func (f Fraction) ToFraction32() Fraction32 {
	return Fraction32{
		...
		denominator: uint32(f.denominator),
	}
...
func (f Fraction) ToComplex128() complex128 {
	return complex(float64(f.numerator)/float64(f.denominator), 0)
}
...
// }
// func (f Fraction32) ToInt32() int64 {
// 	return int64(f.numerator) / int64(f.denominator)
// }
